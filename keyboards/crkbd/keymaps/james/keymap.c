...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(LALT_T(KC_ESC), KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, LT(2,KC_TAB), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, RALT_T(KC_QUOT), LSFT_T(KC_GRV), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_BSLS), LCTL_T(KC_LBRC), LGUI_T(KC_MINS), LT(1,KC_SPC), LT(1,KC_ENT), RGUI_T(KC_EQL), RCTL_T(KC_RBRC)),
	[1] = LAYOUT(KC_TRNS, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC, KC_CAPS, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_RALT, KC_TRNS, KC_LCBR, KC_UNDS, KC_PPLS, KC_RCBR, KC_TRNS, KC_TRNS, KC_LBRC, KC_MINS, KC_EQL, KC_RBRC, KC_LSFT, KC_TRNS, KC_TRNS, LT(3,KC_NO), LT(3,KC_NO), KC_TRNS, KC_TRNS),
